      ...
      useEffect(() => {
        ...
        return (
            <section className="Coffee">
              ...
              <Button color="#E3D7CA" label="Delete Coffee Review"onClick={coffeeDelete}></Button>
              <Button color="#E3D7CA" label="Edit" onClick={() => {navigate(`/coffee/edit/${coffee.id}`)}}></Button>
            </section>
          )
        }
