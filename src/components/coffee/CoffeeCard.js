...
export const CoffeeCard = ({ coffee }) => {
    ...
    return (
    <Card  direction="row" gap="small" height="medium" width="medium" background="#FCEFEE" 
        border={{color: '#481D24', size: 'medium'}} pad="xsmall">
        <div>
        ...
        <div class="actorPics"><img src={coffee.actorRatings.url} alt="Keanu Reeves" height="100px"/></div>
